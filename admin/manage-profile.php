                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="">
                                                        <input type="password" class="form-control" id="password"
                                                            name="password" placeholder="E.g. Admin@123" value="" <?php echo $required;?> pattern="^(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[!@#$%^&*_=+-]).{8,}$" title="The Minimum Password Length is 8 and Must contain at least 1 number, 1 uppercase, 1 lowercase, 1 Special character">
